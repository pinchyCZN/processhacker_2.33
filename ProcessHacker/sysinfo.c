    ...
    )
{
    ...
    {
    case 0: // New colors
        DrawInfo->BackColor = GetSysColor(COLOR_WINDOW);
        ...
        DrawInfo->GridColor = GetSysColor(COLOR_GRAYTEXT);
        DrawInfo->TextColor = GetSysColor(COLOR_WINDOW);
        DrawInfo->TextBoxColor = GetSysColor(COLOR_ACTIVEBORDER);
        break;
    case 1: // Old colors
    ...
    )
{
    ...
    {
    case 0: // New colors
        CurrentParameters.GraphBackColor = GetSysColor(COLOR_WINDOW);
        CurrentParameters.PanelForeColor = GetSysColor(COLOR_GRAYTEXT);
        break;
    case 1: // Old colors
        CurrentParameters.GraphBackColor = GetSysColor(COLOR_WINDOW);
        CurrentParameters.PanelForeColor = GetSysColor(COLOR_GRAYTEXT);
