    ...
    )
{
    ...
    context->DrawInfo.BackColor = GetSysColor(COLOR_WINDOW);
    ...
    context->DrawInfo.TextColor = GetSysColor(COLOR_WINDOWTEXT);
    context->DrawInfo.TextBoxColor = GetSysColor(COLOR_ACTIVEBORDER);

    context->Options.FadeOutBackColor = GetSysColor(COLOR_WINDOW);
